...
# PYO3_USE_ABI3_FORWARD_COMPATIBILITY is applied only as a retry in build-wheels.sh (cachebox, ormsgpack): set here
# for every build it breaks crates that use PyO3's full API, like pydantic-core.
